...
export const TOUR_PACKAGES: TourPackage[] = [
  ...
  },
  {
    ...
    timelineDays: [
      { day: "Day 1", title: "Accra to Kumasi Heritage Fly-In", desc: "Board an executive short flight to Kumasi, the cultural heartbeat of West Africa." },
  ...
  },
  {
    ...
    timelineDays: [
      ...
      { day: "Day 9", title: "Final Accra Return route", desc: "Scenic road trip back to Accra, stopping at local fruit plantations, ending your wilderness story." }
    ],
    travelerPricing: [
  ...
  },
  {
    ...
    startingPrice: 38500,
    currency: "GH₵",
    description: "Rejuvenate your soul among deep spiritual temples, volcanic forest ranges, and ancient terraced rice paddies in Ubud and Seminyak.",
    image: "https://images.unsplash.com/photo-1537953773345-d172ccf13cf1?auto=compress&cs=tinysrgb&w=800",
    inclusions: [
      "Return international flights from Accra",
      "7 Nights luxury private pool villa in Ubud & Seminyak",
      "Uluwatu Cliff Sunset Temple & Kecak fire dance tour",
      "Tegalalang rice terraces swing and jungle breakfast",
      "Traditional Balinese holistic spa & flower bath",
      "Private driver and English-speaking local guide"
    ],
    exclusions: [
      "Personal shopping & alcohol",
      "Optional white water rafting gear"
    ],
    timelineDays: [
      { day: "Day 1", title: "Denpasar Arrival & Ubud Jungle Villa", desc: "Land at Ngurah Rai International Airport. Private escort transfer into your tranquil Ubud infinity pool villa surrounded by tropical jungle." },
      { day: "Day 2", title: "Tegalalang Rice Terraces & Jungle Swing", desc: "Witness lush tiered emerald paddies at sunrise, ride the famous Bali jungle swing, and taste organic Luwak coffee." },
      { day: "Day 3", title: "Sacred Monkey Forest & Tirta Empul Cleansing", desc: "Walk through mossy ancient temple ruins populated by long-tailed macaques and participate in a holy spring water blessing." },
      { day: "Day 4", title: "Mount Batur Sunrise Jeep Trek", desc: "Take a 4x4 open-top jeep safari to watch the clouds ignite over Mount Batur volcano at dawn, followed by natural hot springs." },
      { day: "Day 5", title: "Transfer to Seminyak & Sunset Beach Club", desc: "Check into your chic Seminyak oceanfront suite, unwind on golden sands, and enjoy sunset cocktails at iconic beach clubs." },
      { day: "Day 6", title: "Uluwatu Ocean Cliff Temple & Kecak Dance", desc: "Perch high above crashing Indian Ocean waves on dramatic limestone cliffs while watching a mesmerizing traditional fire dance." },
      { day: "Day 7", title: "Nusa Penida Island Speedboat Day Trip", desc: "Cruise across crystal waters to Kelingking T-Rex beach viewpoint, snorkel with giant manta rays at Manta Point." },
      { day: "Day 8", title: "Balinese Farewell & Airport Transfer", desc: "Relax with a final four-hand aromatherapy massage before your chauffeured airport transfer back to Accra." }
    ],
    travelerPricing: [
      { id: "Adult", label: "Adult Single", subLabel: "GH₵38,500.00", price: 38500 },
      { id: "Couple", label: "Couple Package", subLabel: "GH₵72,000.00", price: 72000 },
      { id: "ChildWithBed", label: "Child With Bed", subLabel: "GH₵34,200.00", price: 34200 }
    ]
  },
  {
    id: "tour-uk-heritage",
    name: "UNITED KINGDOM ROYAL MONARCHY & LONDON SIGHTS",
    duration: "7 Days",
    region: "EUROPE",
    startingPrice: 42000,
    currency: "GH₵",
    description: "Experience classical British royal estates, historical stone castles, and high-contrast London metropolitan culture with guided visits to Windsor and Tower Bridge.",
    image: ukCoverImage,
    inclusions: [
      "Return flights from Accra to London Heathrow",
      "6 Nights central 4-star boutique hotel in London",
      "London Eye fast-track VIP champagne flight",
      "Windsor Castle, Stonehenge & Oxford day tour",
      "Tower of London & Crown Jewels admission",
      "Oyster transit card with preloaded credit"
    ],
    exclusions: [
      "UK Standard Visitor Visa fees",
      "Personal theater show tickets",
      "Gratuities for tour guides"
    ],
    timelineDays: [
      { day: "Day 1", title: "London Arrival & Thames Evening Walk", desc: "Arrive at London Heathrow. Private executive transfer to your central London hotel, followed by an evening stroll along the River Thames." },
      { day: "Day 2", title: "Royal London: Buckingham Palace & Big Ben", desc: "Witness the Changing of the Guard, tour Westminster Abbey, and capture Big Ben from Westminster Bridge." },
      { day: "Day 3", title: "Tower of London & London Eye VIP", desc: "Explore 1,000 years of royal history at the Tower of London, see the Crown Jewels, and ride the London Eye at sunset." },
      { day: "Day 4", title: "Windsor Castle, Stonehenge & Roman Baths Excursion", desc: "Full-day luxury coach tour to HM Queen's favorite royal castle, mysterious prehistoric stone circles, and ancient Roman spas." },
...
export function getDestinationImages(destinationName: string): string[] {
  ...
  if (name.includes("dubai")) {
    return [
      "https://images.unsplash.com/photo-1518684079-3c830dcef090?auto=compress&cs=tinysrgb&w=800",
      "https://images.unsplash.com/photo-1512453979798-5ea266f8880c?auto=compress&cs=tinysrgb&w=800",
      dubaiMuseumImage,
      dubaiBurjImage
    ];
  }
...
export function getTourPackageForCard(cardOriginalName: string): TourPackage {
  ...
  switch (cardOriginalName) {
    ...
    case "Maldives":
      return TOUR_PACKAGES.find(p => p.id === "tour-maldives-sanctuary")!;

    case "Bali":
      return TOUR_PACKAGES.find(p => p.id === "tour-bali-rejuvenation")!;

    case "Zanzibar":
      return TOUR_PACKAGES.find(p => p.id === "tour-explore-zanzibar-nairobi")!;

    case "United Kingdom":
      return TOUR_PACKAGES.find(p => p.id === "tour-uk-heritage")!;

    case "United States":
      return TOUR_PACKAGES.find(p => p.id === "tour-us-skylines")!;

    case "Europe":
      return TOUR_PACKAGES.find(p => p.id === "tour-best-of-europe-august")!;

    case "Morocco":
      return TOUR_PACKAGES.find(p => p.id === "tour-morocco-souks")!;

    case "South Africa":
      return TOUR_PACKAGES.find(p => p.id === "tour-south-africa-safari")!;
    ...
    default:
      return {
        ...
        timelineDays: [
          ...
          { day: "Day 2", title: "Iconic Historical Landmarks Tour", desc: "See the world-renowned historic sites with our expert native historians." },
          ...
          { day: "Day 5", title: "Private VIP Catamaran Cruise & Coastal Rest", desc: "Relish in private boat rides around beautiful coordinates, enjoying fresh BBQ on deck." },
...
export const ALL_TOUR_PACKAGES = TOUR_PACKAGES;
export const travelServices = SERVICES_CATALOG;
